...
public class Сontainer implements Serializable  {
  ...
  public void d_comparison(Сontainer conteiner)
  {
	  int a,b;
	  while(true)
	  {
	  System.out.print("\nведіть індекс першого елементу: ");
	   a=in.nextInt();
	  ...
	  int temp =Сontainer.comparison(conteiner.m_data[a],conteiner.m_data[b]);
